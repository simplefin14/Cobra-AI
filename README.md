...
n8n: Plataforma de automação de workflow (self-hosted) para orquestrar todo o processo (leitura de dados, chamadas à IA, lógica de loop, integração com Evolution API).
